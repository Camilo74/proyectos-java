...
public class ClientUDPTest {
	...
	public static void main(String[] args) {
		try {
			// 1. crear el socket por donde se enviara la peticion y se recibira la respuesta..
			DatagramSocket socket = new DatagramSocket(32000);
			// 2. crear datagrama para enviar la info. el datagrama contiene toda la info necesaria para que llegue el msj
