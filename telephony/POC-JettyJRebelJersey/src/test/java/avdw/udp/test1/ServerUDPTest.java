...
public class ServerUDPTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 3. enviar respuesta..
			String resp = new Date().toString();// la hora como respueta.
			// 3.1 crear datagrama de envio.
			// direccion destino..
			InetAddress addr = paqueteCliente.getAddress();// la misma del cliente.
			
			int port = paqueteCliente.getPort();
			// el datagrama contiene la infromacion del destino.
